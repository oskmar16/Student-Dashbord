...
document.getElementById("settings-btn").onclick=()=>{document.getElementById("hourly-wage").value=data.settings.hourlyWage||"";window.cloudDashboard?.showConfiguration();document.getElementById("settings-dialog").showModal();};
