const CACHE_NAME="min-hverdag-v8";
const APP_SHELL=["./","./index.html","./styles.css","./app.js","./cloud-sync.js","./pwa.js","./manifest.webmanifest","./icons/icon.svg","./icons/icon-192.png","./icons/icon-512.png"];
