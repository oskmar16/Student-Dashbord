const CACHE_NAME="min-hverdag-v10";
const APP_SHELL=["./","./index.html","./styles.css","./app.js","./cloud-sync.js","./pwa.js","./manifest.webmanifest?v=20260827-2","./icons/icon.svg?v=20260827-2","./icons/min-hverdag-192.png","./icons/min-hverdag-512.png"];
